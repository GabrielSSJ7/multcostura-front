...
function EditMachine(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, !title ? __jsx("h1", {
    ...
    onClick: function onClick() {
      console.log(getParam(state.video), state.video);

      if (getParam(state.video) != 0) {
        Object(_utils_machines__WEBPACK_IMPORTED_MODULE_7__["updateMachine"])(state, machineFiles, sewingFile, refProdFiles, {
          folheto: folheto,
          manual: manual
        }, function (err, res) {
          if (err) {
...
//# sourceMappingURL=machine.js.d0a2b238f70314c7e038.hot-update.js.map