			  	...
			  	<Row className="media-r" style={{ flexWrap: 'wrap' }}>
				  	...
				  	{listProdsPag[indexPag].map(prod => 
				  	 ...
				  	 >
                                          ...
                                          <div style={{ background: "#EEEEEE", padding: "3px 10px", maxWidth: "85%", marginTop: "10px", width: "85%" }}>
                                            <Name>{prod.name}</Name>
                                          </div>

                                          <p style={{ maxWidth: "80%", fontFamily: "arial", lineHeight: "25px", minHeight: "90px" }}>
                                            {prod.mainFeatures.length > 40 ? prod.mainFeatures.substr(0, 100) + "..." : prod.mainFeatures}
                                          </p>
                                          <Line />
