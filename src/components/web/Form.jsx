...
export default function Form() {
      ...
      setApi()
        ...
        .then((response) => {
          ...
          setSnackBar({
            ...
            result: "success",
            message:
              "E-mail enviado com sucesso, em breve retornaremos o seu contato!",
          });
        })
        .catch((err) => {
          setVisLoad(false);
  ...
  function validateFields() {
    ...
    return {
      ...
      message: `Campo${
        emptyF.length > 1 ? "s" : ""
      } ${emptyF.toString().replace(/\W+/g, ", ")} vazios`,
    };
  }
  ...
  return (
    <>
      {visLoad ? (
        <Column flex="1" jc="center" ait="center">
          <img src={loading} style={{ width: "64px", height: "64px" }} />
        </Column>
      ) : (
        <Column flex="1" style={{ minWidth: "300px", marginBottom: "20px" }}>
          ...
          <Row style={{ justifyContent: "flex-end" }}>
            ...
            <Button
              onClick={sendMail}
              style={{ background: "#242873", marginLeft: "5px" }}
            >
              Enviar
            </Button>
          </Row>
